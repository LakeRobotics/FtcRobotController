...
@Disabled
 public class IRSensor {
     ...
     double[] safeArray = {safeBS1,safeBS2, safeFS1,safeFS2, safeRS1,safeRS2, safeLS1, safeLS2};
     ...
     public DistanceSensor LSensor1;
      public DistanceSensor LSensor2;
   ...
   public void initSensor(HardwareMap hwmap){
     ...
     LSensor1 = hwmap.get(DistanceSensor.class, "LDistance"); LSensor2 = hwmap.get(DistanceSensor.class, "LDistance2");
